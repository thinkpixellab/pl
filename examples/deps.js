...
goog.addDependency("../../../pl/examples/demos/carouselDemo.js", ['demos.CarouselDemo'], ['goog.Timer', 'goog.debug.LogManager', 'goog.events', 'goog.events.EventType', 'goog.math.Coordinate', 'goog.math.Vec2', 'pl.DebugDiv', 'pl.FpsLogger', 'pl.ex', 'pl.gfx', 'pl.retained.Animation', 'pl.retained.CarouselContainer', 'pl.retained.Stage', 'pl.retained.Text', 'pl.retained.helper']);
...
goog.addDependency("../../../pl/examples/demos/scaleDemo.js", ['demos.ScaleDemo'], ['goog.Timer', 'goog.debug.LogManager', 'goog.math.Coordinate', 'goog.math.Vec2', 'pl.ex', 'pl.gfx', 'pl.retained.Animation', 'pl.retained.CarouselContainer', 'pl.retained.Stage', 'pl.retained.Text', 'pl.retained.helper']);
goog.addDependency("../../../pl/examples/demos/swap.js", ['demos.Swap'], ['goog.Timer', 'goog.debug.LogManager', 'goog.math.Coordinate', 'goog.math.Vec2', 'pl.DebugDiv', 'pl.FpsLogger', 'pl.ex', 'pl.retained.Animation', 'pl.retained.Container', 'pl.retained.Stage', 'pl.retained.Text']);
goog.addDependency("../../../pl/examples/demos/tile.js", ['demos.Tile'], ['goog.Timer', 'goog.debug.LogManager', 'goog.math.Coordinate', 'goog.math.Vec2', 'pl.ex', 'pl.retained.Container', 'pl.retained.Stage', 'pl.retained.TileLayer']);
goog.addDependency("../../../pl/examples/demos/transition.js", ['demos.Transition'], ['goog.Timer', 'goog.debug.LogManager', 'goog.math.Coordinate', 'goog.math.Vec2', 'pl.DebugDiv', 'pl.FpsLogger', 'pl.ex', 'pl.retained.Container', 'pl.retained.Stage', 'pl.retained.Text']);
...
goog.addDependency("../../../pl/src/retained/animation.js", ['pl.retained.Animation'], ['pl.Behavior', 'pl.retained.EventType']);
