...
goog.addDependency("../../../pl/examples/demos/carouselDemo.js", ['demos.CarouselDemo'], ['goog.debug.LogManager', 'goog.math.Coordinate', 'goog.Timer', 'goog.math.Vec2', 'goog.events', 'goog.events.EventType', 'pl.ex', 'pl.gfx', 'pl.retained.Stage', 'pl.retained.Text', 'pl.retained.CarouselContainer', 'pl.retained.Animation', 'pl.retained.helper', 'pl.FpsLogger', 'pl.DebugDiv']);
goog.addDependency("../../../pl/examples/demos/demos.js", ['demos'], ['demos.CarouselDemo', 'demos.ScaleDemo', 'demos.Swap', 'demos.Tile', 'demos.Transition']);
goog.addDependency("../../../pl/examples/demos/scaleDemo.js", ['demos.ScaleDemo'], ['goog.debug.LogManager', 'goog.math.Coordinate', 'goog.Timer', 'goog.math.Vec2', 'pl.ex', 'pl.gfx', 'pl.retained.helper', 'pl.retained.Stage', 'pl.retained.Text', 'pl.retained.CarouselContainer', 'pl.retained.Animation']);
goog.addDependency("../../../pl/examples/demos/swap.js", ['demos.Swap'], ['goog.debug.LogManager', 'goog.math.Coordinate', 'goog.Timer', 'goog.math.Vec2', 'pl.ex', 'pl.retained.Stage', 'pl.retained.Text', 'pl.retained.Container', 'pl.retained.Animation', 'pl.FpsLogger', 'pl.DebugDiv']);
goog.addDependency("../../../pl/examples/demos/tile.js", ['demos.Tile'], ['goog.debug.LogManager', 'goog.math.Coordinate', 'goog.Timer', 'goog.math.Vec2', 'pl.ex', 'pl.retained.Container', 'pl.retained.Stage', 'pl.retained.TileLayer']);
goog.addDependency("../../../pl/examples/demos/transition.js", ['demos.Transition'], ['goog.debug.LogManager', 'goog.math.Coordinate', 'goog.Timer', 'goog.math.Vec2', 'pl.ex', 'pl.retained.Stage', 'pl.retained.Text', 'pl.retained.Container', 'pl.FpsLogger', 'pl.DebugDiv']);
...
goog.addDependency("../../../pl/src/retained/container.js", ['pl.retained.Container'], ['goog.array', 'goog.asserts', 'pl.retained.Element']);
goog.addDependency("../../../pl/src/retained/element.js", ['pl.retained.Element'], ['goog.asserts', 'goog.color.alpha', 'goog.graphics.AffineTransform', 'goog.math.Coordinate', 'goog.math.Rect', 'goog.math.Size', 'pl.gfx']);
