...
// Please do not edit.
goog.addDependency('../../../pl/examples/demoHost.js', ['DemoHost'], ['demos', 'goog.History', 'goog.Timer', 'goog.asserts', 'goog.debug.LogManager', 'goog.dom', 'goog.object', 'goog.string', 'goog.style', 'goog.ui.Component.EventType', 'goog.ui.MenuItem', 'goog.ui.Select', 'pl.DebugDiv', 'pl.FpsLogger', 'pl.ex', 'pl.images', 'pl.retained.EventType']);
goog.addDependency('../../../pl/examples/demos/carouselDemo.js', ['demos.CarouselDemo'], ['demos.DemoBase', 'goog.events', 'goog.events.EventType', 'pl.retained.Animation', 'pl.retained.CarouselPanel', 'pl.retained.Stage', 'pl.retained.Text', 'pl.retained.helper']);
goog.addDependency('../../../pl/examples/demos/demoBase.js', ['demos.DemoBase'], ['goog.array', 'goog.asserts', 'pl.retained.Element', 'pl.retained.EventType', 'pl.retained.Stage']);
goog.addDependency('../../../pl/examples/demos/demos.js', ['demos'], ['demos.CarouselDemo', 'demos.DemoBase', 'demos.GraphDemo', 'demos.NavLayerDemo', 'demos.RotateTextDemo', 'demos.ScaleDemo', 'demos.Squares', 'demos.SwapDemo', 'demos.TileDemo']);
goog.addDependency('../../../pl/examples/demos/graphDemo.js', ['demos.GraphDemo', 'demos.GraphDemo.Node'], ['demos.DemoBase', 'goog.fx.DragEvent', 'goog.fx.Dragger', 'goog.fx.Dragger.EventType', 'goog.math.Vec2', 'pl.Graph', 'pl.gfx', 'pl.retained.GraphElement']);
...
goog.addDependency('../../../pl/examples/demos/rotateTextDemo.js', ['demos.RotateTextDemo'], ['demos.DemoBase', 'pl.retained.Panel', 'pl.retained.Stage', 'pl.retained.Text']);
...
goog.addDependency('../../../pl/examples/demos/squares.js', ['demos.Squares'], ['demos.DemoBase', 'goog.math.Box', 'goog.math.Coordinate', 'goog.math.Size', 'pl.ex', 'pl.retained.Animation', 'pl.retained.Panel', 'pl.retained.Shape', 'pl.retained.Stage']);
goog.addDependency('../../../pl/examples/demos/swapDemo.js', ['demos.SwapDemo'], ['demos.DemoBase', 'goog.math.Size', 'pl.ex', 'pl.retained.Animation', 'pl.retained.Panel', 'pl.retained.Shape', 'pl.retained.Stage']);
goog.addDependency('../../../pl/examples/demos/tileDemo.js', ['demos.TileDemo'], ['demos.DemoBase', 'goog.math.Vec2', 'pl.retained.Panel', 'pl.retained.Stage', 'pl.retained.TileLayer']);
