...
// Please do not edit.
goog.addDependency('../../../pl/examples/retained/demoHost.js', ['DemoHost'], ['demos', 'goog.History', 'goog.Timer', 'goog.asserts', 'goog.debug.LogManager', 'goog.dom', 'goog.fx.anim', 'goog.fx.anim.Animated', 'goog.object', 'goog.string', 'goog.style', 'goog.ui.Component.EventType', 'goog.ui.MenuItem', 'goog.ui.Select', 'pl.DebugDiv', 'pl.FpsLogger', 'pl.ex', 'pl.images', 'pl.retained.EventType']);
goog.addDependency('../../../pl/examples/retained/demos/carouselDemo.js', ['demos.CarouselDemo'], ['demos.DemoBase', 'goog.events', 'goog.events.EventType', 'pl.retained.Animation', 'pl.retained.CarouselPanel', 'pl.retained.Stage', 'pl.retained.Text', 'pl.retained.helper']);
goog.addDependency('../../../pl/examples/retained/demos/demoBase.js', ['demos.DemoBase'], ['goog.array', 'goog.asserts', 'pl.retained.Element', 'pl.retained.EventType', 'pl.retained.Stage']);
goog.addDependency('../../../pl/examples/retained/demos/demos.js', ['demos'], ['demos.CarouselDemo', 'demos.DemoBase', 'demos.GraphDemo', 'demos.NavLayerDemo', 'demos.RotateTextDemo', 'demos.ScaleDemo', 'demos.Squares', 'demos.SwapDemo', 'demos.TileDemo']);
goog.addDependency('../../../pl/examples/retained/demos/graphDemo.js', ['demos.GraphDemo', 'demos.GraphDemo.Node'], ['demos.DemoBase', 'goog.fx.DragEvent', 'goog.fx.Dragger', 'goog.fx.Dragger.EventType', 'goog.math.Vec2', 'pl.Graph', 'pl.gfx', 'pl.retained.GraphElement']);
goog.addDependency('../../../pl/examples/retained/demos/navLayerDemo.js', ['demos.NavLayerDemo'], ['goog.events', 'goog.events.EventType', 'goog.math.Coordinate', 'pl.retained.Canvas', 'pl.retained.NavLayer', 'pl.retained.Shape', 'pl.retained.Stage', 'pl.retained.Text', 'pl.retained.mouse']);
goog.addDependency('../../../pl/examples/retained/demos/rotateTextDemo.js', ['demos.RotateTextDemo'], ['demos.DemoBase', 'pl.retained.Panel', 'pl.retained.Stage', 'pl.retained.Text']);
goog.addDependency('../../../pl/examples/retained/demos/scaleDemo.js', ['demos.ScaleDemo'], ['goog.math.Vec2', 'pl.gfx', 'pl.retained.Animation', 'pl.retained.Image', 'pl.retained.Stage']);
goog.addDependency('../../../pl/examples/retained/demos/squares.js', ['demos.Squares'], ['demos.DemoBase', 'goog.math.Box', 'goog.math.Coordinate', 'goog.math.Size', 'pl.ex', 'pl.retained.Animation', 'pl.retained.Panel', 'pl.retained.Shape', 'pl.retained.Stage']);
goog.addDependency('../../../pl/examples/retained/demos/swapDemo.js', ['demos.SwapDemo'], ['demos.DemoBase', 'goog.math.Size', 'pl.ex', 'pl.retained.Animation', 'pl.retained.Panel', 'pl.retained.Shape', 'pl.retained.Stage']);
goog.addDependency('../../../pl/examples/retained/demos/tileDemo.js', ['demos.TileDemo'], ['demos.DemoBase', 'goog.math.Vec2', 'pl.retained.Panel', 'pl.retained.Stage', 'pl.retained.TileLayer']);
