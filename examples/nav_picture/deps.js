...
// Please do not edit.
goog.addDependency('../../../pl/examples/nav_picture/demoBase.js', ['demos.DemoBase'], ['goog.array', 'goog.asserts', 'pl.retained.Element', 'pl.retained.EventType', 'pl.retained.Stage']);
goog.addDependency('../../../pl/examples/nav_picture/demoHost.js', ['DemoHost'], ['demos.NavLayerDemo', 'goog.Timer', 'goog.asserts', 'goog.debug.LogManager', 'goog.dom', 'goog.fx.anim', 'goog.fx.anim.Animated', 'goog.object', 'goog.string', 'pl.DebugDiv', 'pl.FpsLogger', 'pl.ex', 'pl.images', 'pl.retained.EventType']);
goog.addDependency('../../../pl/examples/nav_picture/navLayerDemo.js', ['demos.NavLayerDemo'], ['demos.DemoBase', 'goog.events', 'goog.events.EventType', 'goog.math.Coordinate', 'pl.retained.Canvas', 'pl.retained.NavLayer', 'pl.retained.Shape', 'pl.retained.Stage', 'pl.retained.Text', 'pl.retained.mouse']);
